...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultController = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var Marionette = __webpack_require__(4);
	var AlbumsCollection = __webpack_require__(7);
	var ImagesCollection = __webpack_require__(10);
	...
	module.exports = Marionette.Object.extend({
	        ...
	        if (typeof this.albumsCollection.isLoaded == 'undefined') {
	            this.albumsCollection.fetch({
	                success: function success() {
	                    _this.albumsCollection.isLoaded = true;
	                    _this.showAlbums(_this.albumsCollection);
	                }
	            });
	        } else {
	    ...
	    album: function album(id) {
	        ...
	        this.imagesCollection.fetch({
	            success: function success() {
	                _this2.showAlbum(_this2.imagesCollection);
	            }
	        });
	    },

	    showAlbum: function showAlbum(collection) {
	    ...
	    showAlbums: function showAlbums(collection) {
	        var AlbumList = Marionette.View.extend({
	            el: '#app',
	            ui: {
	                viewAlbum: '.viewAlbum'
	            ...
	            onViewAlbum: function onViewAlbum(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var Album = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__p+='\n        <div class="col-sm-6 col-lg-4 col-xl-3 box">\n            <img class="image-fit viewAlbum" src="'+
	((__t=( item.imageUrl ))==null?'':_.escape(__t))+
	'" data-id="'+
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Backbone.Collection.extend({
	    ...
	    setAlbumId: function setAlbumId(id) {
